...
def affine_bnorm_relu_forward(x, w, b, normalization, gamma, beta, bn_param):
    fc_cache = None
    relu_cache = None
    bn_cache = None
    ...
    return out, (fc_cache, relu_cache, bn_cache)

def affine_bnorm_relu_backward(dout, cache, normalization):
    dx, dw, db, dgamma, dbeta = None, None, None, None, None
    fc_cache, relu_cache, bn_cache = cache
    if not normalization:
        dx, dw, db = affine_relu_backward(dout, (fc_cache, relu_cache))
    elif normalization == 'batchnorm':
